...
public class ThuChiMainActivity extends Activity {
	...
	Button themGD, homnay, thangnay, namnay,gt,ls;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		homnay = (Button) findViewById(R.id.imgtoday);
		thangnay = (Button) findViewById(R.id.imgmonth);
		namnay = (Button) findViewById(R.id.imgyear);
		gt= (Button) findViewById(R.id.gioithieu);
		...
		homnay.setOnClickListener(new OnClickListener() {
		...
		thangnay.setOnClickListener(new OnClickListener() {
		...
		gt.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				Intent i = new Intent(ThuChiMainActivity.this,
						GioithieuActivity.class);
				startActivity(i);
			}
		});
		namnay.setOnClickListener(new OnClickListener() {
